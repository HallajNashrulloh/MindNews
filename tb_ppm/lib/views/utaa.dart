...
import 'package:mindnews/views/beranda.dart' show DetailPage, newsUtamaList;
import 'package:mindnews/views/news_card.dart';

class Utaa extends StatefulWidget {
  const Utaa({super.key});

  @override
  _UtaaState createState() => _UtaaState();
}

class _UtaaState extends State<Utaa> {
  int _selectedIndex = 0;
  List<Map<String, dynamic>> newsList = List<Map<String, dynamic>>.from(newsUtamaList);
...
class Utamaa extends StatefulWidget {
  final List<Map<String, dynamic>> newsList;
  final Function(List<Map<String, dynamic>>) onNewsUpdate;

  const Utamaa({super.key, required this.newsList, required this.onNewsUpdate});

  @override
  _UtamaaState createState() => _UtamaaState();
}

class _UtamaaState extends State<Utamaa> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Tambahkan teks BERITA UTAMA dan tombol kembali di bawah search bar
            Padding(
